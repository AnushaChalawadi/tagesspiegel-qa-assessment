...
*** Test Cases ***
TC01 Verify The Registration Process On Tagesspiegel
    ...
    ${random_email}=    Set Variable    ${email_prefix}+${timestamp}@gmail.com
    ...
    Fill Registration Form    ${random_email}    ${vorname}    ${nachname}
    ...
    ...    ${random_email}    ${GMAIL_USER}       ${GMAIL_APP_PASSWORD}    
